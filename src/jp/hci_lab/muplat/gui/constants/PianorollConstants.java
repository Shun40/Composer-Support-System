...
public class PianorollConstants {
	...
	public static final int EDIT_AREA_Y = 120;
	// MeasureArea
	public static final int MEASURE_AREA_X = 110;
	public static final int MEASURE_AREA_Y = 73;
	// Keyboard
	public static final int KEYBOARD_X = 10;
	public static final int KEYBOARD_Y = 120;
	// InstrumentSelector
	public static final int INSTRUMENT_SELECTOR_X = 790;
	public static final int INSTRUMENT_SELECTOR_Y = 120;
	// ParameterSelector
	public static final int PARAMETER_SELECTOR_X = 930;
	public static final int PARAMETER_SELECTOR_Y = 120;
	// TrackMuteSelector
	public static final int TRACK_MUTE_SELECTOR_X = 970;
	public static final int TRACK_MUTE_SELECTOR_Y = 120;
	// TrackSoloSelector
	public static final int TRACK_SOLO_SELECTOR_X = 1030;
	...
	// AlgorithmSelector
	public static final int ALGORITHM_SELECTOR_X = 780;
	public static final int ALGORITHM_SELECTOR_Y = 42;
}
